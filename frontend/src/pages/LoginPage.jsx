    ...
    return (
        <main className="h-screen overflow-hidden bg-white text-slate-950">
            <div className="grid h-screen grid-cols-1 lg:grid-cols-2">
                <section className="relative hidden overflow-hidden bg-gradient-to-br from-white via-[var(--serin-primary-soft)]/60 to-[var(--serin-accent-soft)]/45 px-8 py-5 lg:flex lg:flex-col">
                    <Decorations />
                    ...
                    <div className="w-full max-w-[480px]">
                        ...
                        <div className="rounded-[22px] border border-slate-200 bg-white px-6 py-5 shadow-sm">
                            <div className="text-center">
                                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--serin-primary-soft)] p-2 ring-1 ring-[var(--serin-primary-border)] shadow-sm">
                                    <img
                                        src={serinIcon}
                                        alt="SERIN"
                            ...
                            <form onSubmit={handleSubmit} className="mt-4 space-y-2.5">
                                <div>
                                    ...
                                    <div className="flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 shadow-sm transition focus-within:border-[var(--serin-primary)] focus-within:ring-4 focus-within:ring-[var(--serin-primary-soft)]">
                                ...
                                <div>
                                    ...
                                    <div className="flex h-12 items-center gap-3 rounded-2xl border border-slate-200 bg-white px-4 shadow-sm transition focus-within:border-[var(--serin-primary)] focus-within:ring-4 focus-within:ring-[var(--serin-primary-soft)]">
                                        ...
                                        <button
                                            ...
                                            className="text-slate-400 transition hover:text-[var(--serin-primary)]"
                                        >
                            ...
                            <div className="mt-4 rounded-2xl border border-[var(--serin-primary-border)] bg-[var(--serin-primary-soft)]/70 p-4">
                                <div className="flex items-start gap-3">
                                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-white text-[var(--serin-primary)] ring-1 ring-[var(--serin-primary-border)]">
                                        <Lock size={20} />
                                    </div>
                            ...
                            <div className="mt-3 rounded-2xl border border-[var(--serin-primary-border)] bg-white p-4">
                                <div className="flex items-start gap-3">
                                    <Info
                                        size={18}
                                        className="mt-0.5 shrink-0 text-[var(--serin-primary)]"
                                    />
                                    <div>
                                        <h3 className="text-sm font-extrabold text-[var(--serin-primary-dark)]">
                                            Akses Terbatas
                                        </h3>
                                        <p className="mt-1 text-xs font-medium leading-5 text-slate-600">
...
function Decorations() {
    return (
        <>
            <div className="absolute -bottom-20 -left-28 h-80 w-80 rounded-full bg-[var(--serin-primary-soft)]/80" />
            <div className="absolute -right-32 top-1/2 h-72 w-72 rounded-full bg-[var(--serin-accent-soft)]/70" />
            ...
            <div className="absolute bottom-28 right-0 h-24 w-96 rounded-[50%] border-t border-[var(--serin-accent)]/30" />
            <div className="absolute bottom-20 right-6 h-24 w-96 rounded-[50%] border-t border-[var(--serin-primary)]/25" />
            <div className="absolute bottom-12 right-12 h-24 w-96 rounded-[50%] border-t border-[var(--serin-accent)]/20" />
        </>
    );
}
